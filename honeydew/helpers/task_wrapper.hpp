...
public:
    ...
    */
    ...
    template<typename TaskType> Task& then_close(TaskType&& other) { return then_close(other.close()); }
    ...
    */
    ...
    template<typename TaskType> Task& also(TaskType&& other) { return also_close(other.close()); }
